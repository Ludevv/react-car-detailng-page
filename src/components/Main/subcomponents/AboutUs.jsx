    ...
    <section className={style()}>
      ...
      <div className={style('content')}>
        ...
        <div className={style('row')}>
          ...
          <article className={style('column-second')}><p className={style('header')}>dlaczego my?</p>Dlaczego warto powierzyć swój samochochód właśnie nam? Samochody to&nbsp;nasza pasja. Znamy dokładnie potrzeby naszych Klientów a&nbsp;nasze doświadczenie i&nbsp;wiedza zdobyta na&nbsp;temat auto detailingu sprawia, że&nbsp;Twoje auto będzie wyglądać jak z&nbsp;salonu!</article>
        </div>
      </div>
    </section>
   );
